...
/*!
  ...
  the file will be called .qexpressvpn.ini and will be stored in a directory called ABE.config.  On Linux, the
...
uint8_t envin (OPTIONS *options)
{
  ...
  options->auto_disconnect = settings.value (QString ("auto disconnect"), options->auto_disconnect).toInt ();
